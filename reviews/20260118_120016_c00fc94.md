...
bypassing React reconciler → "Invalid hook call" errors in all 36
...
- `📚 docs: create comprehensive JSX runtime fix documentation`
- `📚 docs(review): add review for commit cbd3b9c`
- `🔧 chore: remove outdated zod-schema-converter review`
