...
pub const HelpOverlay = struct {
    ...
    fn drawBinding(_: *const Self, renderer: DefaultRenderer, bx: u16, by: u16, key: []const u8, desc: []const u8, key_style: DefaultRenderer.Style, desc_style: DefaultRenderer.Style) void {
