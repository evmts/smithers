...
pub const StatusBar = struct {
    ...
    fn drawHelpRow(self: *const Self, renderer: DefaultRenderer, row: u16, hints: []const HintEntry, key_style: DefaultRenderer.Style, bar_style: DefaultRenderer.Style) void {
        _ = self;
        var x: u16 = 2;
        for (hints) |hint| {
