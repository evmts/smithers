---
title: "Hello World"
description: "The simplest possible Smithers agent demonstrating basic usage"
---
...
See [Code Review](/examples/code-review) to learn about tools and structured output.
