...
description: "Multiple research topics investigated concurrently using Subagent"
---
...
| `children` | JSX.Element | Claude components to execute |
...
See [Dev Team](/examples/dev-team) for a complete multi-agent system with Architect, Developer, and Reviewer roles.
