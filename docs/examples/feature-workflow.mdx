  ...
  return (
    <Claude onFinished={(plan) => { setInitialPlan(plan); nextPhase() }}>
      ...
      <OutputFormat schema={{
        ...
        testCases: { type: 'array', items: { type: 'object', properties: {
          name: { type: 'string' },
          description: { type: 'string' },
          inputs: { type: 'string' },
        ...
        apis: { type: 'array', items: { type: 'object', properties: {
          name: { type: 'string' },
  ...
  return (
    ...
    >
      ...
      <OutputFormat schema={{
        ...
        Return a JSON object with POC results.
      </OutputFormat>
      Feature: {prompt}
  ...
  return (
    ...
    >
      ...
      <OutputFormat schema={{
        ...
        refinedPlan: { type: 'object', properties: {
          summary: { type: 'string' },
          steps: { type: 'array', items: { type: 'object', properties: {
            step: { type: 'number' },
            description: { type: 'string' },
        ...
        Return a JSON object with analysis and refined plan.
      </OutputFormat>
