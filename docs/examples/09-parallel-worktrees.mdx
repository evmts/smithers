...
```tsx
import { executePlan, Worktree, Subagent, Claude } from 'smithers'
    ...
    <Subagent name="coordinator" parallel={true}>
      {features.map(feature => (
        <Worktree
          ...
          cleanup={true}
          onCreated={() => console.log(`✓ Worktree created: ${feature.name}`)}
          onCleanup={() => console.log(`✓ Worktree cleaned: ${feature.name}`)}
        >
          <Claude
            allowedTools={['Read', 'Edit', 'Write', 'Bash']}
            onFinished={() => {
              console.log(`✓ Feature complete: ${feature.name}`)
            }}
          >
...
console.log('🚀 Parallel Feature Development Starting')
...
```
🚀 Parallel Feature Development Starting
  Features: auth, api, ui

✓ Worktree created: auth
✓ Worktree created: api
✓ Worktree created: ui
...
✓ Worktree cleaned: auth
✓ Worktree cleaned: api
✓ Worktree cleaned: ui
