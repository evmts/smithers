...
description: "Multi-agent development team with Architect, Developer, and Reviewer roles"
---
...
- [Research Pipeline](/examples/research-pipeline) - Simpler multi-phase workflow
- [Parallel Research](/examples/parallel-research) - Parallel execution patterns
