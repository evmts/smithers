...
- [`createRoot`](./render-plan.mdx#createroot): Creates a SmithersRoot for rendering
...
- **Performance**: Serialization is fast and synchronous. Large trees (1000+ nodes) serialize in ~1ms.
