...
<ParamField path="maxTokens" type="number">
  ...
  <Info>Reserved for future implementation. Currently has no effect.</Info>
</ParamField>
...
<ParamField path="tools" type="Tool[]">
  ...
  <Info>Reserved for future implementation. Use `allowedTools`/`disallowedTools` for built-in tools, or MCP for custom tools.</Info>
