...
The `<SmithersProvider>` component provides unified context to all child components, including database access, execution state, and task orchestration. It's required at the root of every Smithers workflow.
