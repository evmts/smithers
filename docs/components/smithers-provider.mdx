...
description: Root orchestration context
---

# SmithersProvider

Root component. Required. Provides database, execution context, and the Ralph loop.
...
import { SmithersProvider, Claude, useSmithers, If, Stop } from "smithers-orchestrator";
...
function WorkflowContent() {
  ...
  const phase = phaseVal ? JSON.parse(phaseVal) : "start";
