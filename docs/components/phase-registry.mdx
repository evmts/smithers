...
<Note>
`PhaseRegistryProvider` is automatically included in `SmithersProvider`. Manual use is rarely needed.
</Note>

<Note>
Phase index automatically resets to 0 when Ralph iteration changes.
</Note>
