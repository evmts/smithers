...
Auto-generates commit message from diff. Currently uses a simple line-count heuristic.
...
> **Planned:** AI-powered commit message generation (`useAgent`, `template` props) is not yet implemented. Currently generates simple "Changes: N lines modified" messages.
