---
title: Phase & Step Components
description: Organize multi-step prompts with semantic structure
---

# Phase & Step Components

The `<Phase>` and `<Step>` components provide semantic organization for multi-step agent plans. They help structure complex prompts and make plans more readable.

## Phase Component

Defines a named phase in a multi-step workflow.
...
Defines an individual step within a phase or directly inside a Claude component.
...
<CardGroup cols={2}>
  <Card title="Clarity for Claude" icon="brain">
    Phases and steps help Claude understand the expected workflow structure
  </Card>
...
<CardGroup cols={2}>
  <Card title="Claude Component" icon="cube" href="/components/claude">
    The container for phases and steps
  </Card>
  <Card title="Prompt Structure" icon="list" href="/components/prompt-structure">
    Other semantic components (Persona, Constraints, OutputFormat)
  </Card>
</CardGroup>
