...
<ParamField path="id" type="string">
  Stable identifier for resumability. If omitted, Smithers derives one from `key`,
  `message`, and child text. Provide `id` (or React `key`) when you need guaranteed uniqueness.
</ParamField>
