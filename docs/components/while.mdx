...
<Warning>
  **Planned Feature** - This component is not yet implemented.
  See [while-component issue](/issues/while-component.md) for design details and implementation plan.
</Warning>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="github"
    href="/issues/while-component.md"
  >
...
If you have feedback on this planned component, please comment on the [while-component issue](/issues/while-component.md).
