...
Explicitly terminate orchestration with structured summary.
...
|------|------|---------|-------------|
| `summary` | `EndSummary \| (() => EndSummary \| Promise<EndSummary>)` | required | Structured run summary (supports async) |
