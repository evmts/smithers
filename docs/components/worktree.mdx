...
<Steps>
  ...
  <Step title="Git Utilities">
    Implemented worktree management functions: listWorktrees, addWorktree, removeWorktree, branchExists, worktreeExists.
  </Step>

  <Step title="WorktreeContext">
...
If you have feedback on this component, please [open an issue](https://github.com/evmts/smithers/issues).
