...
┌─────────────────────────────────────────────────────────────┐
│  1. RENDER                                                  │
│     JSX Components → PluNode Tree → XML Plan                │
└─────────────────────────────────────────────────────────────┘
                              ↓
┌─────────────────────────────────────────────────────────────┐
│  2. DISPLAY (optional)                                      │
...
2. **`<Subagent>` nodes**: Execute in parallel with each other
3. **Mixed**: The first sequential `<Claude>` runs concurrently with all `<Subagent>` nodes
...
<>
  ...
  <Subagent name="a">
    <Claude>Parallel A</Claude>     {/* Runs with Task 1 */}
  </Subagent>
  <Subagent name="b">
    <Claude>Parallel B</Claude>     {/* Runs with Task 1 */}
  </Subagent>
</>
```
