...
Your orchestrating agent writes React code that spawns and controls other agents. The plan is the code. The code is the plan.
...
const sqliteDb = createSmithersDB({ path: ".smithers/demo" });
