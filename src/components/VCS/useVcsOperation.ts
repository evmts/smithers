...
export interface UseVcsOperationOptions<TState> {
  id?: string
  operationType: string
  defaultState: TState
  execute: (context: VcsOperationContext<TState>) => Promise<void>
  deps?: unknown[]
}

export interface VcsOperationContext<TState> {
...
export function useVcsOperation<TState extends { status: string }>(
  options: UseVcsOperationOptions<TState>
) {
