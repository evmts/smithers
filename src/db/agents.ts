...
const mapAgent = (row: AgentRow | null): Agent | null => {
  ...
  return {
    ...
    ...(row.phase_id !== null && { phase_id: row.phase_id }),
    ...(row.system_prompt !== null && { system_prompt: row.system_prompt }),
    ...(row.result !== null && { result: row.result }),
    ...(row.result_structured !== null && { result_structured: parseJson(row.result_structured, {}) }),
